...
comment on table vw_api_hospitais is
  'Indicadores mensais por hospital (CNES), com regiao de saude, denominadores, amostras e estado de capacidade ja persistidos na Gold. A view nao recalcula indicadores.';
