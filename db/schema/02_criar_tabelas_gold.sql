...
-- ---------------------------------------------------------------------
-- Fato: diagnóstico por hospital, especialidade e competência
-- A migração incremental equivalente está no script 07.
-- ---------------------------------------------------------------------
...
comment on table mart_indicador_hospital_especialidade_cid_mensal is
  'Fato no grao hospital, competencia de processamento, especialidade SIH e CID principal. Usar para perguntas de CID com mes e especialidade. Nasceu diretamente da internacao detalhada com FL_INTERNACAO_NOVA=1; nao pode ser reconstruido juntando marts nem requer join para CID. Somar internacoes e dias; media ponderada e SUM(dias)/SUM(internacoes). Para ranking, ordenar o conjunto completo antes da paginacao.';
