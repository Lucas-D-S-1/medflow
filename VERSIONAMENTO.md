...
| `v1.0.1` | **estável** | Metodologia reorganizada em torno da pergunta que ela responde e acentuação do texto servido pela API; publicada em 29/08/2026 |
| `v1.0.0` | histórico | Índice de permanência por especialidade em todos os grãos, comparação com pares por porte, FlowIA com memória de conversa; contrato de dados `0.5.0`; publicada em 29/08/2026 |
