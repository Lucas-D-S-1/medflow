...
def gerar_geografia(*, base: Path) -> dict[str, int]:
    dir_origem = base / "data" / "bronze" / "origem" / "referencias"
    ...
    dir_silver = base / "data" / "silver" / "dimensoes"
    ...
    dir_geo = base / "data" / "gold" / "geografia"
    ...
    contrato["tabelas"] += [
        _contrato_tabela(
            ...
            dim_municipio,
            "gold",
            "data/gold/geografia/dim_geografia_municipio.csv",
        ),
        _contrato_tabela(
            "dim_geografia_regiao",
            dim_regiao,
            "gold",
            "data/gold/geografia/dim_geografia_regiao.csv",
        ),
    ]
    contrato["ativos"] = [
        {
