...
DESCRICOES_EXATAS = {
    ...
    "cd_distrito_sp": "Código do distrito municipal de São Paulo na camada oficial do GeoSampa.",
    "nm_distrito": "Nome oficial do distrito municipal de São Paulo.",
    "id_subprefeitura_sp": "Identificador canônico da subprefeitura municipal no GeoSampa.",
    "nm_subprefeitura": "Nome oficial da subprefeitura municipal.",
    "id_crs_sms_sp": "Identificador da Coordenadoria Regional de Saúde municipal no GeoSampa.",
    "nm_crs_sms": "Nome da Coordenadoria Regional de Saúde municipal.",
    "id_sts_sms_sp": "Identificador da Supervisão Técnica de Saúde municipal no GeoSampa.",
    "nm_sts_sms": "Nome da Supervisão Técnica de Saúde municipal.",
    "nm_regiao_municipal_5": "Região municipal ampla informada pelo GeoSampa; não é Região de Saúde do SUS.",
    "nm_regiao_municipal_8": "Subdivisão regional municipal informada pelo GeoSampa; não é Região de Saúde do SUS.",
    "nm_zona_popular": "Rótulo municipal amigável para busca; não é chave espacial nem sinônimo de Região de Saúde.",
    "ds_fonte_territorio": "Fonte e sistema de referência usados na atribuição territorial.",
    "dt_referencia_fonte": "Data de referência da edição territorial ou cadastral usada.",
    "nm_bairro_cnes_atual": "Bairro informado pela fotografia atual do cadastro CNES.",
    "vl_latitude_cnes_atual": "Latitude informada pela fotografia atual do cadastro CNES.",
    "vl_longitude_cnes_atual": "Longitude informada pela fotografia atual do cadastro CNES.",
    "tp_metodo_atribuicao": "Método usado para atribuir o hospital ao território municipal.",
    "fl_atribuicao_ambigua": "Indica hospital sem atribuição territorial única no ponto cadastral.",
    "nm_alias": "Nome alternativo governado aceito na busca do hospital.",
    "nm_alias_normalizado": "Alias normalizado para comparação sem acentos e pontuação.",
    "tp_alias": "Tipo do alias: popular, oficial, histórico ou sigla.",
    "fl_alias_preferencial": "Indica alias preferencial dentro do seu tipo.",
    "ds_fonte_alias": "Fonte que sustenta o alias hospitalar.",
    ...
    "vl_cmi_real": "Valor aprovado médio corrigido pelo IPCA para a competência indicada em cd_competencia_preco_referencia.",
    "nr_indice_ipca": "Número-índice mensal do IPCA/IBGE, tabela SIDRA 1737, variável 2266.",
    "nr_fator_correcao_ipca": "Fator que atualiza o valor nominal da competência para o preço de referência explícito.",
    ...
    "qt_internacao_residente_na_propria_regiao": "Internações de residentes atendidos em hospital da própria região de saúde.",
    "qt_evasao_intrastadual_observada": "Internações de residentes atendidos em outra região de saúde de SP; não inclui saídas para outras UFs.",
    "pc_evasao_intrastadual_observada": "Evasão intrastadual observada dividida pelas internações de residentes atendidos em SP.",
    "qt_internacao_recebida_outra_regiao_sp": "Internações realizadas na região para residentes de outra região de saúde paulista.",
    "qt_internacao_recebida_fora_sp": "Internações realizadas na região para residentes de outra unidade da Federação.",
    "pc_atracao_assistencial": "Internações recebidas de fora da região divididas pelo total de internações realizadas na região.",
    "qt_internacao_icsap_residente_observada": "Internações novas de residentes classificadas na Lista Brasileira de ICSAP e atendidas em SP.",
    "pc_icsap_no_total_internacao_residente_observada": "ICSAP divididas por todas as internações novas observadas de residentes; não é o denominador clínico oficial.",
    "tx_icsap_residente_observada_por_10_mil": "ICSAP observadas de residentes por 10 mil habitantes do Censo IBGE 2022.",
    "cd_grupo_icsap": "Código ordinal de dois dígitos do grupo da Lista Brasileira de ICSAP.",
    "nm_grupo_icsap": "Nome do grupo da Lista Brasileira de ICSAP da Portaria SAS/MS 221/2008.",
    "qt_internacao_icsap": "Quantidade de internações novas classificadas no grupo ICSAP.",
    "qt_internacao_icsap_total_regiao": "Total de internações ICSAP observadas entre residentes da região e competência.",
    "pc_grupo_no_total_icsap": "Participação do grupo no total de ICSAP da região e competência.",
    "tx_icsap_grupo_por_10_mil_habitantes": "Internações do grupo ICSAP por 10 mil residentes da região.",
    "cd_origem_residencia": "Região de saúde de residência ou FORA_SP para residentes de outra UF.",
    "nm_origem_residencia": "Nome da região de residência ou indicação de residência fora de São Paulo.",
    "cd_macrorregiao_origem": "Macrorregião de saúde da residência; nula para residentes fora de SP.",
    "nm_macrorregiao_origem": "Nome da macrorregião de residência; nulo para residentes fora de SP.",
    "cd_regiao_saude_atendimento": "Região de saúde do hospital que realizou o atendimento.",
    "nm_regiao_saude_atendimento": "Nome da região de saúde do hospital que realizou o atendimento.",
    "cd_macrorregiao_atendimento": "Macrorregião de saúde do hospital que realizou o atendimento.",
    "nm_macrorregiao_atendimento": "Nome da macrorregião de saúde do hospital que realizou o atendimento.",
    "st_fluxo_assistencial": "Classificação do fluxo: intrarregional, interregional_sp ou entrada_outro_estado.",
    "pc_origem_no_atendimento": "Participação da origem no total de internações realizadas na região de atendimento e competência.",
    "pc_destino_na_origem_observada": "Participação do destino nas internações da origem observadas em hospitais de SP.",
...
DESCRICOES_TABELAS = {
    ...
    "dim_hospital_alias": ("Aliases governados para pesquisa de hospitais.", "uma linha por alias e CNES", ["cd_cnes", "nm_alias_normalizado"]),
    "dim_hospital_territorio_atual": (
        "Atribuição cadastral atual dos hospitais de São Paulo ao território municipal.",
        "uma linha por CNES dentro do município de São Paulo",
        ["cd_cnes"],
    ),
    ...
    "dim_territorio_municipal": (
        ...
        "uma linha por distrito municipal",
...
def publicar_silver(
    *,
    ...
    dominios_md += [
        ...
        "estão em `contracts/dados/MAPEAMENTO_COLUNAS_ORIGEM_SILVER.csv`.",
    ]
...
def documentar_bronze(*, base: Path, manifesto: dict[str, Any]) -> None:
    ...
    descricoes = {
        ...
        "geosampa_distrito_municipal": "GeoJSON bruto dos 96 distritos municipais do GeoSampa.",
        "geosampa_subprefeitura": "GeoJSON bruto das subprefeituras do GeoSampa.",
                ...
                "fonte": manifesto["fontes"].get(
                    {
                        ...
                        "geosampa_distrito_municipal": "PMSP_GeoSampa_WFS",
                        "geosampa_subprefeitura": "PMSP_GeoSampa_WFS",
                        "geosampa_coordenadoria_regional_saude": "PMSP_GeoSampa_WFS",
                        "geosampa_supervisao_tecnica_saude": "PMSP_GeoSampa_WFS",
                    }[nome],
