...
|---|---:|---|---:|---|---|
| `ESPEC` | 16 | nenhum | 100.0000% | mapeado | DATASUS/TabNet |
| `IDENT` | 2 | nenhum | 100.0000% | mapeado | DATASUS/TabNet |
| `COD_IDADE` | 4 | nenhum | 100.0000% | mapeado | Dicionário SIH |
...
| `MARCA_UTI` | 16 | nenhum | 100.0000% | mapeado_multifonte | MS/DATASUS + CEM |
| `NAT_JUR` | 22 | nenhum | 100.0000% | mapeado | CONCLA/IBGE 2021 |
